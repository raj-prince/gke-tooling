...
MOUNT_OPTIONS=${6:-"implicit-dirs,metadata-cache:ttl-secs:60,enable-buffered-read,log-severity=info,read-block-size-mb=16,read-max-blocks-per-handle=20,read-global-max-blocks=40"}
